...
<div style="width: 30%; height: 600px;float: left; background-color: darkblue;">
...
<div
				...
				<h1
					...
					View Feedback</h1> 
<%
String strfeed="select * from feedback";
ResultSet r=CrudOperation.fetchData(strfeed);
%>
...
<tr><th class="heading">UserId</th><th class="heading">Subject</th><th class="heading">Message</th><th class="heading">Date</th></tr>
<%
while(r.next())
		{
	String qt=r.getString("Userid");
%>
<tr>
<th class="txt"><%=qt %></th>
<th class="txt"><%=r.getString("Subject") %></th>
<th class="txt"><%=r.getString("Message") %></th>
<th class="txt"><%=r.getString("Date") %></th>
</tr>
<%}
r.close();
%>
