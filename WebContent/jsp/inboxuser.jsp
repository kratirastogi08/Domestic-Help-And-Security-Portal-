...
<div style="width: 100%; background-color: white; height: 80px;">
	...
	<div style="width: 100%; height: 48px; background-color: black;">
		...
		<div style="background-color: darkblue;width: 30%;height: 600px;float: left;padding-top: 40px;">
...
<%@include file="/WEB-INF/bootstrapdemo.html" %></div>
		...
		<div
				style="background-color: #f2f2f2; width: 70%; height: 400px; border-radius: 4px;margin-left :120px;margin-right:120px;
				...
				<h1
					...
					Inbox</h1> 
<%
    String str ="select * from inbox where ReceiverId=?";
    ResultSet rs = CrudOperation.fetchData(str,userid);
%>
<form action="/dhsp/Inbox" method="post">
<table border="2" style=" margin-top: 40px; border-radius: 5px;margin-right: 10px;background-color: white;width: 90%;text-align: center;margin-left: 20px;">
<tr><th class="heading">Msg Id</th><th class="heading">Sender Id</th><th class="heading">Subject</th>
...
<th class="txt"><%=rs.getString("SenderId")%></th>
...
<tr><th colspan="5" ><button type="submit" style=" width: 50%;
    ...
    text-align:center
    border: none;
    border-radius: 4px; cursor: pointer;">Delete</button></th></tr>
</table>
</form>
</div>
 </div>
