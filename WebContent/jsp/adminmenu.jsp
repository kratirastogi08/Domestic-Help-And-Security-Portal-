...
{
%>
                      <input type="email" class="form-control" value="<%=rs.getString("Id")%>" readonly="readonly"
                      id="sid" name="sid" />
                      <%}
rs.close();
                    %>
                  ...
                  <div class="form-group">
                    <label for="rid" style="color: black">Receiver Address</label>
                      <input type="email" class="form-control" onblur="check()"
...
<a href="/dhsp/jsp/inbox.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Inbox</a></li>
<li style="color: white;margin-left: 20px;margin-top: 15px">
...
<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="#mymodal1" data-toggle="modal" data-target="#myModalNorm1" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Post News</a>
...
<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="/dhsp/jsp/viewenquiry.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >View Enquiry</a></li>
<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="/dhsp/jsp/companyverification.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Company Verification</a></li>
</ul>
</body>
</html>