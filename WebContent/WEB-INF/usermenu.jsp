...
<a href="/dhsp/jsp/inboxuser.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Inbox</a></li>
<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="/dhsp/jsp/sentitemuser.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Sent Item</a></li>
<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="/dhsp/jsp/requestservice.jsp" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Service Request</a></li>

<li style="color: white;margin-left: 20px;margin-top: 15px">
<a href="#mymodal1" data-toggle="modal" data-target="#myModalNorm1" style="color: white;font-size: 20px;font-family: Georgia;text-decoration: none;margin-left: 40px" >Give Feedback</a>
...
<div class="modal fade" id="myModalNorm1" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
              <h4 class="modal-title" style=" color: black;margin-top: 20px;font-size: 20px">Give Feedback</h4>
            <button type="button" class="close" data-dismiss="modal" style="margin-top: 20px">&times;</button>
            ...
            <div class="modal-body">
                ...
                <form role="form" action="/dhsp/Feedback" method="post">
                  <div class="form-group">
                    <label for="userid" style="color: black">UserId</label>
                      <input type="text" class="form-control"
                      id="userid" name="userid" value="<%=userid%>" readonly="readonly"/>
                  </div>
                  <div class="form-group">
                    <label for="subject" style="color: black">Subject</label>
                      <input type="text" class="form-control"
                  ...
                  <div class="form-group">
                    <label for="message" style="color: black">Message</label>
                      ...
                      id="msg" name="msg" placeholder="Type feedback"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="companyid" style="color: black">Company Id</label>
                      <input type="text" class="form-control"
                      id="compid" name="compid" placeholder="Enter company id"/>                  
                      </div>
