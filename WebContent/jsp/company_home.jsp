...
<div style="width: 30%; height: 600px;float: left; background-color: darkblue;padding-top:0;">
...
<div style="width: 70%; height: 600px; float: left;background-image: url('/dhsp/images/subtle_grunge.png');">
  
   
   <div>
       
       <h1 id="txt" style="text-align: center; font-size:70px; font-weight: bold; margin-top: 100px;font-family: Georgia;"> 
       Welcome! 
       <%=userid %> 
       to your home</h1>
